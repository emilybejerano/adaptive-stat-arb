...
CHECKPOINT_BASENAME = f"adaptive_threshold_dqn_{method_suffix()}.pt"
RESULTS_PATH = f"datasets/train_results_{method_suffix()}.pkl"
...
print(f"\nSaved to {CHECKPOINT_BASENAME} and adaptive_threshold_dqn.pt")
